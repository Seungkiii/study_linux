...
mkdir \-p \~/vim\_crud\_practice_hwang/{comp1,comp2,comp3}

cd \~/vim\_crud\_practice_hwang/comp1
...
✅ 명령어 힌트: `/검색`, `yy`, `p`, `:wq`
```
[yhc@192.168.0.51  ~/Downloads/vim_crud_practice_hwang/comp2]$ cat ./todo.txt
1. Clean the house
2. Buy groceries
3. Call Mom
2. Buy groceries
...
✅ 명령어 힌트: `G`, `o`, `i`, `ESC`, `:wq`
```
[yhc@192.168.0.51  ~/Downloads/vim_crud_practice_hwang/comp1]$ cat fruits.txt
Apple
Banana
Cherry
Durian
...
✅ 명령어 힌트: `:%s///`, `yy`, `p`, `:wq`
```
[yhc@192.168.0.51  ~/Downloads/vim_crud_practice_hwang/comp3]$ cat users.csv
Name,Email
